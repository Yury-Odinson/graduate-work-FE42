// urls for registration & authorization
...
export const tmdbPopularMoviesURL = "https://api.themoviedb.org/3/movie/popular?language=en-US&page="
...
export const tmdbLanguages = "https://api.themoviedb.org/3/configuration/languages"
